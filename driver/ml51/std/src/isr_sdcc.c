...
//-----------------------------------------------------------------------------------------------------------
void SPI0_ISR (void) __interrupt (9)           // Vector @  0x4B
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void PWM0_ISR (void) __interrupt (13)    // Vector @  0x6B
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void PWM0_Brake_ISR (void) __interrupt (14)    // Vector @  0x73
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void HardFault_ISR (void) __interrupt (18)      // Vector @  0x93
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void SMC0_ISR (void) __interrupt (19)          // Vector @  0x9B
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void SPI1_ISR (void) __interrupt (22)          // Vector @  0xB3
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void ACMP_ISR (void) __interrupt (23)          // Vector @  0xBB
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void I2C1_ISR (void) __interrupt (24)          // Vector @  0xC3
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void PWM123_ISR (void) __interrupt (25)          // Vector @  0xCB
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void TK_ISR (void) __interrupt (26)             // Vector @  0xD3
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void SMC1_ISR (void) __interrupt (27)          // Vector @  0xDB
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void PDMA2_ISR (void) __interrupt (28)          // Vector @  0xE3
{
    PUSH_SFRS;
...
//-----------------------------------------------------------------------------------------------------------
void PDMA3_ISR (void) __interrupt (29)          // Vector @  0xEB
{
    PUSH_SFRS;
